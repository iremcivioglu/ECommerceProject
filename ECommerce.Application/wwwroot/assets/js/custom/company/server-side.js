...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            ajax: {
                url: "https://localhost:44312/api/customer/GetCustomers",
                type: "POST"
    ...
    var handleEditRowDatatable = () => {
        ...
        editButton.forEach(f => {
            ...
            f.addEventListener('click', function (e) {
                ...
                var customerId = parent.querySelectorAll('td')[1].innerText;
                var customerNumber = parent.querySelectorAll('td')[2].innerText;
                var customerName = parent.querySelectorAll('td')[3].innerText;
                var customerSurname = parent.querySelectorAll('td')[4].innerText;
                var customerAdress = parent.querySelectorAll('td')[5].innerText;
                var phoneNumber = parent.querySelectorAll('td')[6].innerText;
                var email = parent.querySelectorAll('td')[7].innerText;

                $("[name='customer_name']").val(customerName);
                $("[name='customer_citizen_number']").val(customerNumber);
                $("[name='customer_surname']").val(customerSurname);
                $("[name='customer_adress']").val(customerAdress);
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "https://localhost:44312/api/customer/delete/" + id,
