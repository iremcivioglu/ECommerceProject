...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            ajax: {
                url: "https://localhost:44312/api/category/GetCategories",
                type: "POST"
    ...
    var handleEditRowDatatable = () => {
        ...
        editButton.forEach(f => {
            ...
            f.addEventListener('click', function (e) {
                ...
                var categoryNumber = parent.querySelectorAll('td')[2].innerText;
                var categoryName = parent.querySelectorAll('td')[3].innerText;
                var categoryDescription = parent.querySelectorAll('td')[4].innerText;

                $("[name='category_id']").val(categoryId);
                $("[name='category_name']").val(categoryName);
                $("[name='category_citizen_number']").val(categoryNumber);
                $("[name='category_description']").val(categoryDescription);
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const parent = e.target.closest('tr');
                // Get customer name
                const categoryName = parent.querySelectorAll('td')[3].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "https://localhost:44312/api/category/delete/" + id,
