...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            ajax: {
                url: "https://localhost:44312/api/product/GetProducts",
                type: "POST"
    ...
    var handleEditRowDatatable = () => {
        ...
        editButton.forEach(f => {
            ...
            f.addEventListener('click', function (e) {
                ...
                var productBrand = parent.querySelectorAll('td')[3].innerText;
                ...
                $("[name='productBrand']").val(productBrand);
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "https://localhost:44312/api/product/delete/" + id,
